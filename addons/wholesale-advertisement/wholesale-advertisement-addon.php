			...
			if ( 'ced_cwsm_wholesale_advertisement' == $ced_cwsm_current_tab ) {
				...
				<div class="wrap woocommerce wc_addons_wrap ced_cwsm_wc_addons_wrap">
					<ul class="products">
						...
						<li class="product addon_ready">
							<div class="ced_cwsm_anchor_main">
						...
						<li class="product">
							<div>
								...
								<div class="ced_cwsm_temp_class">
									...
									<a href="#ced_cwsm_suggestion_div" class="suggest_uus button-secondary" data-num="<?php esc_html_e( 'Wholesale Taxation Add-On', 'wholesale-market' ); ?>"><?php esc_html_e( 'Suggest Features', 'wholesale-market' ); ?></a>
								</div>
							</div>
						</li>
						...
						<li class="product">
							<div>
								...
								<div class="ced_cwsm_temp_class">
									...
									<a href="#ced_cwsm_suggestion_div" class="suggest_uus button-secondary" data-num="<?php esc_html_e( 'Wholesale Shipping Add-On', 'wholesale-market' ); ?>"><?php esc_html_e( 'Suggest Features', 'wholesale-market' ); ?></a>
								</div>
							</div>
						</li>
						...
						<li class="product">
							<div>
								...
								<div class="ced_cwsm_temp_class">
									...
									<a href="#ced_cwsm_suggestion_div" class="suggest_uus button-secondary" data-num="<?php esc_html_e( 'Wholesale Payment Add-On', 'wholesale-market' ); ?>"><?php esc_html_e( 'Suggest Features', 'wholesale-market' ); ?></a>
								</div>
							</div>
						</li>
					</ul>
