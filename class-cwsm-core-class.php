...
class CED_CWSM_Core_Class {
	...
	public $ced_cwsm_add_product_meta_fields_OBJ;
	public $ced_cwsm_manage_wholesale_price_OBJ;
	public $ced_cwsm_show_wholesale_price_on_frontEnd_OBJ;
	...
	public function enqueue_common_styles_and_scripts() {
		...
		if ( strpos( $request_uri, 'page=wholesale_market' ) ) {
			...
			wp_enqueue_style( 'ced_cwsm_product_panel_css', plugins_url( 'assets/css/product-panel.css', __FILE__ ), array(), '1.0.0', true );
		}
	}
